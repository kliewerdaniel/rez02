...
const featuredProjects = [
  ...
  },
  {
    ...
    stars: 10,
    githubUrl: 'https://github.com/kliewerdaniel/OpenAIAgentsSDKOllama01',
    projectType: 'AI/ML'
  },
  {
    ...
    stars: 7,
    githubUrl: 'https://github.com/kliewerdaniel/news08',
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="space-y-16">
          {featuredProjects.map((project, index) => (
            <article key={index} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
              <div className="p-8">
                {/* Project Header */}
